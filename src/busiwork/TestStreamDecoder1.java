...
public class TestStreamDecoder1 extends Reader
{
    ...
    public static TestStreamDecoder1 forInputStreamReader(InputStream in,
                                                     Object lock,
                                                     String charsetName)
        throws UnsupportedEncodingException
    {
        ...
        try {
            if (Charset.isSupported(csn))
                return new TestStreamDecoder1(in, lock, Charset.forName(csn));
    ...
    public static TestStreamDecoder1 forInputStreamReader(InputStream in,
                                                     ...
                                                     Charset cs)
    {
        return new TestStreamDecoder1(in, lock, cs);
    }
    ...
    public static TestStreamDecoder1 forInputStreamReader(InputStream in,
                                                     ...
                                                     CharsetDecoder dec)
    {
        return new TestStreamDecoder1(in, lock, dec);
    }


    // Factory for java.nio.channels.Channels.newReader

    public static TestStreamDecoder1 forDecoder(ReadableByteChannel ch,
                                           CharsetDecoder dec,
                                           int minBufferCap)
    {
        return new TestStreamDecoder1(ch, dec, minBufferCap);
    }
    ...
    TestStreamDecoder1(InputStream in, Object lock, Charset cs) {
        this(in, lock,
         cs.newDecoder()
    ...
    TestStreamDecoder1(InputStream in, Object lock, CharsetDecoder dec) {
        super(lock);
        this.cs = dec.charset();
        this.decoder = dec;
    ...
    TestStreamDecoder1(ReadableByteChannel ch, CharsetDecoder dec, int mbc) {
        this.in = null;
        this.ch = ch;
        this.decoder = dec;
        this.cs = dec.charset();
